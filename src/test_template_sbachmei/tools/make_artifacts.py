...
from test_template_sbachmei.constants import data_keys, metadata
from test_template_sbachmei.tools.app_logging import add_logging_sink, decode_status
from test_template_sbachmei.utilities import sanitize_location
...
def build_single_location_artifact(
    ...
    from test_template_sbachmei.data import builder

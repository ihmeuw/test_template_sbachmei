...
if __name__ == "__main__":
    ...
    about = {}
    with open(os.path.join(src_dir, "test_template_sbachmei", "__about__.py")) as f:
        exec(f.read(), about)
    ...
    data_requirements = ["vivarium_inputs[data]==5.0.3"]
    ...
    setup(
        ...
        zip_safe=False,
        use_scm_version={
            "write_to": "src/test_template_sbachmei/_version.py",
        ...
        entry_points="""
            [console_scripts]
            make_artifacts=test_template_sbachmei.tools.cli:make_artifacts
            make_results=test_template_sbachmei.tools.cli:make_results
        """,
    )
